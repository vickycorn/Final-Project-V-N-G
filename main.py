...
#Adjusting the visuals for the textbox of narration
testing_textbox = ui.Textbox(("player__has decided to__)"), (0,0,0), (123, 92, 0), (600,35), (12), (0, 210), time = 5000)
#testing_character setup for bam
testing_character = classes.Char("Bam", 10, 10, 10, 10, 10)
#This adjusts the size of the character box on the screen by changing its x and y axis values
testing_character.rect.x = 30
testing_character.rect.y = 30
#adds text above character, adjusts colour, size of textbox, and time the text will appear on screen
